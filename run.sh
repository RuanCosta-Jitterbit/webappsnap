...
## Default values file. Default: ./cfg/defaults.json (defined in config.js)
# SNAP_DEFAULTS_FILE=./cfg/defaults-2.9.1.json

## PMM Server credentials
# Username. Default: 'user' field in defaults file ("admin")
# SNAP_USER=
# Password. Default: 'pass' field in defaults file ("admin")
# SNAP_PASS=

## Image base directory. Default: 'img_dir' in defaults file ("./images")
...
## Log in and snap the login screen. Default: 'log_in' field in defaults file (true)
# SNAP_LOG_IN=false
...
## Snap viewport. Default: 'img_width' and 'img_height' in defaults file (1280, 720)
# Note: Can be overridden per dashboard or per step (see pmm-qan entries in dashboards file)
# SNAP_IMG_WIDTH=1920
# SNAP_IMG_HEIGHT=1080

## Image scale factor. Multiplies WIDTH and HEIGHT by this value. Default: 'img_scale' in defaults file (1)
# Note: Use with .jpg file and JPG_QUALITY to reduce image file size
# SNAP_IMG_SCALE=0.5

## JPG Quality (% value). Default: 'jpg_quality' in defaults file (100)
# SNAP_JPG_QUALITY=75

## Image filetype (.jpg or .png). Default: 'img_ext' in defaults file (".jpg")
# SNAP_IMG_EXT=.png
...
## Headless mode. Whether to hide browser while snapping. Default: 'headless' in defaults file (true)
# SNAP_HEADLESS=false
