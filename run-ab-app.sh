...
# SNAP_DEFAULTS_FILE=./cfg/jitterbit/app-builder-app/defaults.json
...
# SNAP_SRV_CFG_FILE=./cfg/jitterbit/app-builder-app/blankapp.json
...
SNAP_IMG_DIR="images/AppBuilderApp/$(date +%Y%m%d)/$(date +%H%M)/"
